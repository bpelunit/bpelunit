 ...
 * 
 * (Copied from JUnitProgressBar from the JUnit Eclipse plugin)
 * 
 */
public class BPELUnitProgressBar extends Canvas {
	...
	public BPELUnitProgressBar(Composite parent) {
	...
	private void paint(PaintEvent event) {
		...
		drawBevelRect(gc, rect.x, rect.y, rect.width - 1, rect.height - 1, disp.getSystemColor(SWT.COLOR_WIDGET_NORMAL_SHADOW), disp
