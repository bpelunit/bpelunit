...
/**
 * The helper class for creating entry fields with label and text. Optionally, a button can be added
 * after the text. The attached listener reacts to all the events. Entring new text makes the entry
 * 'dirty', but only when 'commit' is called is 'valueChanged' method called (and only if 'dirty'
 * flag is set). This allows delayed commit.
 */
public class FormEntry {
	...
	/**
	 * Sets the value of this entry with the possibility to turn the notification and validation
	 * off.
	 * 
	 * @param value
	 * @param blockNotification
