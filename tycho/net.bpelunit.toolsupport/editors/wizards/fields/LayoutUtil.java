...
/**
 * Layout utilities for the components
 * 
 */
public class LayoutUtil {
	...
	/**
	 * Sets the vertical alignment of a control. Assumes that GridData is used.
	 */
	public static void setVerticalAlign(Control control, int verticalAlign) {
		Object ld= control.getLayoutData();
		if (ld instanceof GridData) {
			((GridData) ld).verticalAlignment= verticalAlign;
		}
	}
