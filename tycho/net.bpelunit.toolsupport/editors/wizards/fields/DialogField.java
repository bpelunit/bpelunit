 ...
 * independed from the creation time of the widgets. - support for automated layouting. - enable /
 * disable, set focus a concept of the base class.
 * 
...
public class DialogField {
	...
	/**
	 * Tries to set the focus to the dialog field. Returns <code>true</code> if the dialog field
	 * can take focus. To be reimplemented by dialog field implementors.
	 */
	 ...
	 * assumed to have <code>MGridLayout</code> as layout. The dialog field will adjust its
	 * controls' spans to the number of columns given. To be reimplemented by dialog field
	 * implementors.
	 */
	...
	protected boolean hasLabel() {
		return (fLabelText != null) && !"".equals(fLabelText);
	}
