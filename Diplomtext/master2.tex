...
\subsubsection{Basisaktivitäten}
\input{basisaktivitaeten}
\subsubsection{Strukturierte Aktivitäten}
...
\input{bpelformal}
\section{Definition der Abdeckungsmetriken für BPEL}
\input{konventionelleMetriken}
\section{Verfahren für die Messung der Testabdeckung}
\input{konzepte}
