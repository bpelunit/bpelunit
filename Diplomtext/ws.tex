...
Während die erste Definition die konkreten Interaktionsprotokollen und Beschreibungssprache für die Schnittstellen noch offen lässt, werden in der nächste Definition die  geeigneten Standards genannt. 
\begin{Def}
...
werden. SOAP setzt auf Transportschicht auf und ist von dem verwendetetn Transportprotokoll unabhängig. Am Häufigsten wird der HTTP-Protokoll eingesetzt.
...
Katalogisieren und Verwalten von Metadaten über Web-
Services.
...
Die Abbildung ... zeigt den Web Service Technologie Stack.  
