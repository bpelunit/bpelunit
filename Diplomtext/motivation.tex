...
\section{BPEL Testing Grundlagen}
...
Testen von BPEL ist besonders weil BPEL Prozess externale Abhängigkeiten in Form von Web Services. Das macht das Testen schwieriger  Kompletter Systemtest kann nur durchgeführt werden wenn alle Web Services erreichbar reproduzierbare Ergebnisse liefern. Das ist schwer zu erreichen bei externen Service Anbietern. Im schlechtesten Fall das führt zu wenigen hauptsächlich am Ende des entwicklungprojekts.Als Ergebnis werden Fehler entdeckt nur vor der Auslieferung, was exposes hohe Fixkosten und das Risiko verzögerter Ablaufplan. Anderes Problem ist das Testen gegen Fehlerbedingungen, das heißt wenn Web Service antortet Fehler oder ist nicht erreichbar.  Solche Fehlerbedingunmgen müssen simuliert werden  als Teil des Tests.
