...
\item $<$assign$>$ - Manipulation von Variablenwerten.
...
\item $<$forEach$>$ -  iterative Ausführung von Aktivitäten. Die Ausführung kann entweder seriell und parallel erfolgen (gesteuert durch Attribut \textit{parallel}).
