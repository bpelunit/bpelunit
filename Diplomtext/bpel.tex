...
Leymann – Mit BPEL 2.0 existiert eine standardisierte Modellierungssprache für Geschäftsprozesse, aber die Zielgruppe der Benutzer von BPEL sind IT-Benutzer – nicht die Mitarbeiter auf Business-Level. Ein riesengroßer Fortschritt, der durch BPEL erreicht wurde, ist, dass es nun ein einziges Runtime-Modell für Geschäftsprozesse gibt, eine feste operationale Semantik, die wohldefiniert ist. Abstrakt kann man sich das vorstellen als ein einziges logisches Tool das hilft, dass man eine einheitliche Schnittstelle zu den Prozessmaschinen auf IT-Ebene hat. Die Modellierungswerkzeuge auf der Business-Ebene müssen dazu BPEL exportieren.
...
verschiedene Dienste zu einer Gesamtanwendung zu verknüpfen. Dies
...
(in Form eines XSLT-Dokuments) und die Daten aus Variable “A” übergeben.
...
Der Standard wurde im April 2003 an OASIS zur Standardisierung übergeben. as OASIS WS-BPEL Komitee beschloss am 14. September 2004, die Spezifikation WS-BPEL 2.0 zu nennen, um in Einklang mit den anderen WS-*-Standards wie WSDL, WS-Security usw. zu gelangen.
