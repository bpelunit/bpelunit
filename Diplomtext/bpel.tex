WS-BPEL(kurz BPEL) ist eine XML-basierte, ausführbare Sprache zur Modellierung und Beschreibung
...
(Scope) durch einen eindeutigen Namen und einen Datentyp definiert. 
	\item $<$activity$>$ - Geschäftslogik in Form von Aktivitäten. 
\end{itemize}
...
Die ActiveBPEL-Engine ist eine Runtime-Umgebung für die Business Process Execution Language, die in Java implementiert und sowohl BPEL 1.1 als auch BPEL2.0 konform ist. 
Die Engine läuft innerhalb des Apache Tomcat Servers und stellt dort die zum automatischen Geschäftsprozess zusammengefassten Web Services - wiederum als Web Service - zur Verfügung. Zum Deployen wird eine Archivdatei, die das BPEL-Modell, WSDLDateien
und den Engine-spezifischen Deployment Descriptor enthält, in das bpr-Verzeichnis
des Servers, auf dem die ActiveBPEL-Engine läuft, abgelegt. 
