 In diesem Abschnitt werden die Metriken für die Messung der Testabdeckung in BPEL definiert. Dabei werden die in Abschnitt \ref{Abdeckungsmetriken} beschrieben Abdeckungsmetriken an BPEL-Kontext angepasst und neue spezifische Metriken eingeführt.  Bei allen Metriken wurde darauf geachtet, dass die 100\% Abdeckung beim Testen erreicht werden kann. ... die Metriken die Qualität der Tests im bezug auf einen bestimmten Aspekt des Kontrollflußes wiederspiegeln Die Relation größere Wert bessere Tests.
