...
BPELUnit ist ein Framework zum Testen von BPEL-Kompositionen in Isolation. Es ermöglicht wiederholbare white-box-Tests zu erstellen, zu speichern und auszuführen. 
...
\begin{itemize}
	...
	\item ant 
		\item Eclipse plugin 
\end{itemize}
 Bei den ersten beiden Clients erfolgt die Konfiguration über XML-Dokumente, die im Konfigurationsverzechnis (\textit{conf}) der BPELUnit-Installation abgelegt sind. Eclipse plugin ermöglicht neben der graphischen Darstellung des Ergebnisses auch komfortable Erstellung der Tests mit Hilfe eines Editors.
...
\end{itemize}
 ...
 \begin{figure}[htbp]
	\centering
		...
		\caption{Sequenzen in einem Testfall}
	\label{fig:sequenzen}
\end{figure}
...
Für die Auswahl der relevanten Daten wird XPath verwendet. 
...
Für das Deployment eines BPEL-Prozesses sind anbieterspezifische \textit{deployment descriptoren} erforderlich, die nicht standardisiert sind. Das Deployen des BPEL-Prozesses ist, wie bereits erläutert notwendig, und wird durch BPELUnit automatisch ausgeführt. Dazu muss für die jeweilige Engine ein entsprechendes Adatpter implementiert werden.
...
Eine wichtige Information beim Testen ist die erreichte Testabdeckung. Eine entsprechende Erweiterung wird im praktischen Abschnitt dieser Arbeit vorgenommen.
