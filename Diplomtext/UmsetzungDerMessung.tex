...
\end{itemize}
In den beiden Fällen wird eine Aktivität zu viel registriert. Anders gesagt: die Aktivität wird fälschlicherweise als "`ausgeführt"' markiert.
