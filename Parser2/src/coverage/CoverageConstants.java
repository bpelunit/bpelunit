...
public class CoverageConstants {
	...
	public static final String COVERAGE_SERVICE_WSDL = "_CoverageReportingService_.wsdl";
	...
	public static final String PART_OF_REGISTER_MESSAGE = PART_OF_REPORTING_MESSAGE;
