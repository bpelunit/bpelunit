...
//		} else {
			Element literal = new Element(BpelXMLTools.LITERAL_TAG,
					BpelXMLTools.getBpelNamespace());
...
//		startValue.setAttribute(BpelXMLTools.EXPRESSION_LANGUAGE_ATTRIBUTE, XpathLanguage.LANGUAGE_SPEZIFIKATION);
		startValue.setAttribute(BpelXMLTools.EXPRESSION_LANGUAGE_ATTRIBUTE,XpathLanguage.LANGUAGE_SPEZIFIKATION);
		startValue.setText(XpathLanguage.valueOf(variableWithStartValue.getAttributeValue(BpelXMLTools.ATTRIBUTE_NAME)));
...
//		} else {
			literal = new Element(BpelXMLTools.LITERAL_TAG,
					BpelXMLTools.getBpelNamespace());
...
//		stopValue.setAttribute(BpelXMLTools.EXPRESSION_LANGUAGE_ATTRIBUTE, XpathLanguage.LANGUAGE_SPEZIFIKATION);

		stopValue.setAttribute(BpelXMLTools.EXPRESSION_LANGUAGE_ATTRIBUTE,XpathLanguage.LANGUAGE_SPEZIFIKATION);
		stopValue.setText(XpathLanguage.valueOf(variableWithStopValue.getAttributeValue(BpelXMLTools.ATTRIBUTE_NAME)));
...
//				XpathLanguage.LANGUAGE_SPEZIFIKATION);
		...
		String[] strings=new String[]{'\''+MetricHandler.MARKER_IDENTIFIRE2+'\'',XpathLanguage.valueOf(variableWithStartValue
				.getAttributeValue(BpelXMLTools.ATTRIBUTE_NAME)),
				'\''+MetricHandler.MARKER_SEPARATOR+'\'' ,XpathLanguage.valueOf(variableWithStopValue
						.getAttributeValue(BpelXMLTools.ATTRIBUTE_NAME)),
						'\''+MetricHandler.MARKER_SEPARATOR+'\'' ,'\''+ marker+'\''};
		from.setText(XpathLanguage.concat(strings));
		CMServiceFactory cmFactory = CMServiceFactory.getInstance();
		Element stringVariable = BpelXMLTools.createStringVariable();
		cmFactory.insertVariableForRegisterMarker(stringVariable.getAttributeValue(BpelXMLTools.ATTRIBUTE_NAME));
		to = new Element(BpelXMLTools.TO_TAG, BpelXMLTools.getBpelNamespace());
		...
		BranchMetric.insertMarkerForParallelForEach(activity,marker, counterVariable);
